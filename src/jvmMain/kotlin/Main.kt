...
@Suppress("MaxLineLength") // TODO read from file
private const val BiomeDefinitionList =
...
fun handlePlayerPackets(session: MinecraftSession) {
  val biomeDefinitionListNbt = Base64.getDecoder().decode(BiomeDefinitionList.toByteArray())
